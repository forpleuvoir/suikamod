...
public class ItemRegistry {
    ...
    public static Ryuujinjakka RYUUJINJAKKA;
    public static RyuujinjakkaPlus RYUUJINJAKKA_PLUS;
    public static Raikiri RAIKIRI;
    ...
    static {
        if (IS_ENABLED) {
            ...
            RYUUJINJAKKA = new Ryuujinjakka(ToolMaterials.NETHERITE, 5, 1.0f, settings());
            RYUUJINJAKKA_PLUS = new RyuujinjakkaPlus(ToolMaterials.NETHERITE, 10, 1.0f, settings());
            RAIKIRI = new Raikiri(settings());
        }
    }
